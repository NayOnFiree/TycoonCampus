...
État de validation : neuf suites natives réussies (`Saved/Tests/Native/55557bc062eb47f492e81cb1d22fbc98`). Le scénario Unreal exécuté sans recompilation avait réussi avec le cache DDC mémoire, mais le premier workflow Unreal du commit intégré a ensuite révélé deux erreurs de compilation Slate. Elles ont été corrigées dans le sous-jalon suivant ; une nouvelle compilation complète est requise avant validation joueur.
